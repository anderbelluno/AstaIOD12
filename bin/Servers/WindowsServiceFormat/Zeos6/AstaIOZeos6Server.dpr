...
uses
  ...
  AstaIOZeos6SupplementDM in 'AstaIOZeos6SupplementDM.pas' {AstaIOADODBPluginDM: TDataModule};
...
begin
  ...
  //default will be AstaIOADOServer
...
// call this next constructor if there are no dependencies to worry about
  ...
  Application.CreateForm(TAstaIOADODBPluginDM, AstaIOADODBPluginDM);
