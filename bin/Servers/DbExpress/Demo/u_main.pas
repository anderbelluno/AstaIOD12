...
{       Params[i].DataType := ClientParams[i].DataType;}//Steve Garland
         end;
       end;
    end;
  ...
  LogIt('RowsAffected : ' + inttostr(RowsAffected));
end;
...
//   if InTransaction then  
   if not InTransaction then // Corrigido
   begin
    TD.TransactionID := 1;
