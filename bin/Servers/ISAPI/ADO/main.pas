...
type
  TAstaWebModule = class(TWebModule)
...
procedure TAstaWebModule.WebModuleCreate(Sender: TObject);
begin
...
procedure TAstaWebModule.AstaModuleTransferAction(Sender: TObject;
  Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
begin
...
procedure TAstaWebModule.WebModuleDestroy(Sender: TObject);
begin
