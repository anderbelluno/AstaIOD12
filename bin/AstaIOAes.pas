...
{**********************************************************************}
{}
{ $Log:  10011: AstaIOAes.pas
{
{   Rev 1.0    4/10/2003 6:26:02 AM  Steve
}
(**************************************************)
(*                                                *)
...
type
  ...
  PAESExpandedKey192 = ^TAESExpandedKey192; // jn 08/22/2004
  PAESExpandedKey256 = ^TAESExpandedKey256; // jn 08/22/2004

{$ifdef AstaAESKey128} // jn 08/22/2004
  TAESKey         = TAESKey128;
  TAESExpandedKey = TAESExpandedKey128;
  PAESKey         = ^TAESKey128;
  PAESExpandedKey = PAESExpandedKey128;
{$endif}
{$ifdef AstaAESKey192} // jn 08/22/2004
  TAESKey         = TAESKey192;
  TAESExpandedKey = TAESExpandedKey192;
  PAESKey         = ^TAESKey192;
  PAESExpandedKey = PAESExpandedKey192;
{$endif}
{$ifdef AstaAESKey256} // jn 08/22/2004
  TAESKey         = TAESKey256;
  TAESExpandedKey = TAESExpandedKey256;
  PAESKey         = ^TAESKey256;
  PAESExpandedKey = PAESExpandedKey256;
{$endif}

  AesKeyType = (aesEncKey, aesDecKey, aesBothKey);
