...
type TBase64 = class(TObject)
     private
      ...
      function filterLine(InputData:AnsiString):AnsiString;
     protected
     public
      function EncodeData(InputData:AnsiString;var OutputData:AnsiString):Byte;
      function DecodeData(InputData:AnsiString;var OutputData:AnsiString):Byte;
      constructor Create;
     published
...
//******************************************************************
function TBase64.ValueToCharacter(value:Byte;var character:AnsiChar):boolean;
begin
 Result:=true;
...
//******************************************************************
function TBase64.CharacterToValue(character:AnsiChar;var value:byte):boolean;
begin
 Result:=true;
...
//******************************************************************
function TBase64.EncodeData(InputData:AnsiString;var OutputData:AnsiString):Byte;
var i:integer;
    currentb,prevb:Byte;
    c:Byte;
    s:AnsiChar;
...
//******************************************************************
function TBase64.filterLine(InputData:AnsiString):AnsiString;
var f:byte;
    i:integer;
begin
   result:='';
...
// returns BASE64_OK if conversion was done without errors
//******************************************************************
function TBase64.DecodeData(InputData:AnsiString;var OutputData:AnsiString):Byte;
var i:integer;
    InputLength:integer;
    currentb,prevb:Byte;
    c:Byte;
