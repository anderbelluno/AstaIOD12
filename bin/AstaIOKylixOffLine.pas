...
{**********************************************************************}
{}
{ $Log:  10209: AstaIOKylixOffLine.pas 
{
{   Rev 1.0    4/10/2003 6:31:22 AM  Steve
}
unit AstaIOKylixOffLine;
...
type
  TKylixOffLineDialog = class(TForm)
    pan_bot: TPanel;
    btn_ok: TBitBtn;
    btn_cancel: TBitBtn;
    pan_top: TPanel;
...
var
  KylixOffLineDialog: TKylixOffLineDialog;

implementation

{$R *.dfm}

procedure TKylixOffLineDialog.FormDestroy(Sender: TObject);
begin
  NoSQLFields.Free;
  PrimeFields.Free;
  RefetchFields.Free;
...
procedure TKylixOffLineDialog.FormCreate(Sender: TObject);
begin
...
procedure TKylixOffLineDialog.MoveItemDown(ListBox: TListBox);
var idx :Integer;
begin
...
procedure TKylixOffLineDialog.MoveItemUp(ListBox: TListBox);
var idx :Integer;
begin
  if ListBox.Items.Count = 0 then exit;
  if ListBox.ItemIndex = -1 then ListBox.ItemIndex:=0;
...
procedure TKylixOffLineDialog.sb_PrimeFields_upClick(Sender: TObject);
begin
  MoveItemUp(lb_PrimeFields);
end;

procedure TKylixOffLineDialog.sb_PrimeFields_downClick(Sender: TObject);
begin
  MoveItemDown(lb_PrimeFields);
end;

procedure TKylixOffLineDialog.btn_PrimeFields_deleteClick(Sender: TObject);
begin
  DeleteItem(lb_PrimeFields);
end;

procedure TKylixOffLineDialog.DeleteItem(ListBox: TListBox);
begin
  if ListBox.Items.Count = 0 then exit;
  ListBox.Items.Delete(ListBox.ItemIndex);
end;

procedure TKylixOffLineDialog.btn_PrimeFields_replaceClick(Sender: TObject);
begin
  ReplaceItem(lb_PrimeFields, e_PrimeFields.Text);
end;

procedure TKylixOffLineDialog.ReplaceItem(ListBox: TListBox; Value:String);
begin
...
procedure TKylixOffLineDialog.AddItem(ListBox: TListBox; Value: String);
begin
  if Trim(Value) = '' then Exit;
...
procedure TKylixOffLineDialog.btn_PrimeFields_addClick(Sender: TObject);
begin
  AddItem(lb_PrimeFields, e_PrimeFields.Text);
end;

procedure TKylixOffLineDialog.FormActivate(Sender: TObject);
begin
...
procedure TKylixOffLineDialog.btn_okClick(Sender: TObject);
begin
  Apply;
end;

procedure TKylixOffLineDialog.sb_PrimeFieldsClick(Sender: TObject);
begin
  showmessage('This will display a dialog that contains the cached fields, from which they can select a field'); 
end;

procedure TKylixOffLineDialog.btn_NoSQLFields_replaceClick(Sender: TObject);
begin
  ReplaceItem(lb_NoSQLFields, e_NoSQLFields.Text);
end;

procedure TKylixOffLineDialog.btn_NoSQLFields_addClick(Sender: TObject);
begin
  AddItem(lb_NoSQLFields, e_NoSQLFields.Text);
end;

procedure TKylixOffLineDialog.btn_NoSQLFields_deleteClick(Sender: TObject);
begin
  DeleteItem(lb_NoSQLFields);
end;

procedure TKylixOffLineDialog.sb_NoSQLFields_upClick(Sender: TObject);
begin
  MoveItemUp(lb_NoSQLFields);
end;

procedure TKylixOffLineDialog.sb_NoSQLFields_downClick(Sender: TObject);
begin
  MoveItemDown(lb_NoSQLFields);
end;

procedure TKylixOffLineDialog.lb_NoSQLFieldsClick(Sender: TObject);
begin
  if lb_NoSQLFields.ItemIndex < 0 then exit;
  e_NoSQLFields.Text:=lb_NoSQLFields.Items[lb_NoSQLFields.ItemIndex];
end;

procedure TKylixOffLineDialog.lb_RefetchFieldsClick(Sender: TObject);
begin
  if lb_RefetchFields.ItemIndex < 0 then exit;
  e_RefetchFields.Text:=lb_RefetchFields.Items[lb_RefetchFields.ItemIndex];
end;

procedure TKylixOffLineDialog.btn_RefetchSQLFields_replaceClick(Sender: TObject);
begin
  ReplaceItem(lb_RefetchFields, e_RefetchFields.Text);
end;

procedure TKylixOffLineDialog.btn_RefetchSQLFields_addClick(Sender: TObject);
begin
  AddItem(lb_RefetchFields, e_RefetchFields.Text);
end;

procedure TKylixOffLineDialog.btn_RefetchSQLFields_deleteClick(Sender: TObject);
begin
  DeleteItem(lb_RefetchFields);
end;

procedure TKylixOffLineDialog.sb_RefetchSQLFields_upClick(Sender: TObject);
begin
  MoveItemUp(lb_RefetchFields);
end;

procedure TKylixOffLineDialog.sb_RefetchSQLFields_downClick(Sender: TObject);
begin
