...
// File generated on 12.11.2001 17:27:56 from Type Library described below.
...
// *********************************************************************//
  IXMLDocument2 = interface(IDispatch)
    ...
    function  Get_doctype: WideString; safecall;
    function  Get_dtdURL: WideString; safecall;
    function  createElement(vType: OleVariant; var1: OleVariant): IXMLElement2; safecall;
    function  Get_async: WordBool; safecall;
    procedure Set_async(pf: WordBool); safecall;
...
// *********************************************************************//
  IXMLError = interface(IUnknown)
    ...
    procedure GetErrorInfo(var pErrorReturn: TGUID); safecall;
  end;
...
{$ENDIF}
  ...
  protected
    procedure InitServerData; override;
    function  Get_root: IXMLElement2;
    function  Get_url: WideString;
    procedure Set_url(const p: WideString);
    function  Get_readyState: Integer;
    function  Get_charset: WideString;
    procedure Set_charset(const p: WideString);
    function  Get_version: WideString;
    function  Get_doctype: WideString;
    function  Get_async: WordBool;
    procedure Set_async(pf: WordBool);
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    ...
    procedure Disconnect; override;
    function  createElement(vType: OleVariant): IXMLElement2; overload;
    function  createElement(vType: OleVariant; var1: OleVariant): IXMLElement2; overload;
...
function  TXMLDocument.Get_root: IXMLElement2;
begin
  Result := DefaultInterface.Get_root;
end;

function  TXMLDocument.Get_url: WideString;
begin
  Result := DefaultInterface.Get_url;
end;

procedure TXMLDocument.Set_url(const p: WideString);
begin
  DefaultInterface.Set_url(p);
end;
...
function  TXMLDocument.Get_charset: WideString;
begin
  Result := DefaultInterface.Get_charset;
end;

procedure TXMLDocument.Set_charset(const p: WideString);
begin
  DefaultInterface.Set_charset(p);
end;

function  TXMLDocument.Get_version: WideString;
begin
  Result := DefaultInterface.Get_version;
end;

function  TXMLDocument.Get_doctype: WideString;
begin
  Result := DefaultInterface.Get_doctype;
end;

function  TXMLDocument.Get_async: WordBool;
begin
  Result := DefaultInterface.Get_async;
end;

procedure TXMLDocument.Set_async(pf: WordBool);
begin
  DefaultInterface.Set_async(pf);
end;

function  TXMLDocument.createElement(vType: OleVariant): IXMLElement2;
begin
  Result := DefaultInterface.createElement(vType, EmptyParam);
end;

function  TXMLDocument.createElement(vType: OleVariant; var1: OleVariant): IXMLElement2;
begin
  Result := DefaultInterface.createElement(vType, var1);
end;
...
function  TXMLDocumentProperties.Get_root: IXMLElement2;
begin
  Result := DefaultInterface.Get_root;
end;

function  TXMLDocumentProperties.Get_url: WideString;
begin
  Result := DefaultInterface.Get_url;
end;

procedure TXMLDocumentProperties.Set_url(const p: WideString);
begin
	DefaultInterface.Set_url(p);
end;

function  TXMLDocumentProperties.Get_readyState: Integer;
begin
  Result := DefaultInterface.Get_readyState;
end;

function  TXMLDocumentProperties.Get_charset: WideString;
begin
  Result := DefaultInterface.Get_charset;
end;

procedure TXMLDocumentProperties.Set_charset(const p: WideString);
begin
  DefaultInterface.Set_charset(p);
end;

function  TXMLDocumentProperties.Get_version: WideString;
begin
  Result := DefaultInterface.Get_version;
end;

function  TXMLDocumentProperties.Get_doctype: WideString;
begin
  Result := DefaultInterface.Get_doctype;
end;

function  TXMLDocumentProperties.Get_async: WordBool;
begin
  Result := DefaultInterface.Get_async;
end;

procedure TXMLDocumentProperties.Set_async(pf: WordBool);
begin
  DefaultInterface.Set_async(pf);
end;
...
procedure Register;
begin
  RegisterComponents('Servers',[TDOMDocument, TDOMFreeThreadedDocument, TXMLHTTPRequest, TXMLDSOControl, 
    TXMLDocument]);
end;
