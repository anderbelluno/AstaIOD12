...
type
  TfrmAstaSoapElmEdit = class(TFrame)
  ...
  public
    { Public declarations }
    procedure LoadParamTypes(ComplexTypes: TAstaSoapComplexTypeList);
    procedure SetElements(AElements: TAstaSoapMethodElementList);
...
procedure TfrmAstaSoapElmEdit.LoadParamTypes(ComplexTypes: TAstaSoapComplexTypeList);
var
  i: Integer;
begin
  cbxComplex.Clear;
  ...
  begin
    cbxComplex.Items.Add(ComplexTypes[i].Name);
  end;
...
procedure TfrmAstaSoapElmEdit.SetElements(AElements: TAstaSoapMethodElementList);
begin
  Elements:= AElements;
  LoadElements;
  SetControlState;
...
procedure TfrmAstaSoapElmEdit.SetControlState;
var
  fl: Boolean;
begin
...
procedure TfrmAstaSoapElmEdit.SetElementView(el: TAstaSoapMethodElement; li: TListItem);
begin
  li.Caption:= el.Name;
end;

procedure TfrmAstaSoapElmEdit.LoadElements;
var
  i: Integer;
  li: TListItem;
...
procedure TfrmAstaSoapElmEdit.AddElement;
var
  li: TListItem;
  el: TAstaSoapMethodElement;
begin
  el:= Elements.AddSimpleElement('New element', xdString);
  li:= lvwElements.Items.Add;
  li.Caption:= el.Name;
  li.Data:= el;
  li.Selected:= True;
...
procedure TfrmAstaSoapElmEdit.DeleteElement;
var
  S: String;
  i: Integer;
begin
...
procedure TfrmAstaSoapElmEdit.tbnAddClick(Sender: TObject);
begin
  AddElement;
end;

procedure TfrmAstaSoapElmEdit.tbnDeleteClick(Sender: TObject);
begin
  DeleteElement;
end;

procedure TfrmAstaSoapElmEdit.ToolButton1Click(Sender: TObject);
begin
  LoadElements;
end;

procedure TfrmAstaSoapElmEdit.lvwElementsKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if Key = VK_Delete then begin tbnDeleteClick(self); Key:= 0; end;
end;

procedure TfrmAstaSoapElmEdit.lvwElementsSelectItem(Sender: TObject;
...
procedure TfrmAstaSoapElmEdit.edtNameChange(Sender: TObject);
var
  el: TAstaSoapMethodElement;
begin
  if lvwElements.Selected = nil then Exit;
...
procedure TfrmAstaSoapElmEdit.rbnSimpleClick(Sender: TObject);
var
  el: TAstaSoapMethodElement;
begin
  if lvwElements.Selected = nil then Exit;
...
procedure TfrmAstaSoapElmEdit.rbnComplexClick(Sender: TObject);
var
  el: TAstaSoapMethodElement;
begin
  if lvwElements.Selected = nil then Exit;
...
procedure TfrmAstaSoapElmEdit.cbxSimpleChange(Sender: TObject);
var
  el: TAstaSoapMethodElement;
begin
  if lvwElements.Selected = nil then Exit;
...
procedure TfrmAstaSoapElmEdit.cbxComplexChange(Sender: TObject);
var
  el: TAstaSoapMethodElement;
begin
  if lvwElements.Selected = nil then Exit;
